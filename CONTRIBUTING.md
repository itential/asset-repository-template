# Contributing to asset-repository-template

Thank you for your interest in contributing to the asset-repository-template project! This document provides guidelines and instructions for contributing to this project.
...
1. **Fork and clone the repository:**
   ```bash
   git clone https://github.com/YOUR-USERNAME/asset-repository-template.git
   cd asset-repository-template
   ```

2. **Add the upstream remote:**
   ```bash
   git remote add upstream https://github.com/itential/asset-repository-template.git
   ```
...
Thank you for contributing to asset-repository-template!
